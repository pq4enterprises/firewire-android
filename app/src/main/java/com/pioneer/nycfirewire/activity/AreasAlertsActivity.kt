...
import com.pioneer.nycfirewire.databinding.ActivityAreasAlertsBinding
import com.pioneer.nycfirewire.databinding.ItemAreaGroupBinding
import com.pioneer.nycfirewire.databinding.ItemAreaRowBinding
...
class AreasAlertsActivity : BaseActivity() {
     ...
     */
    private fun isBasicUser(): Boolean = (prefs.userRole ?: "") == Constants.USER_BASIC_USER
