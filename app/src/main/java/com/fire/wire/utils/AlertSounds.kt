 ...
 * are redirected onto the current channel by [com.fire.wire.notification.NotificationServiceExtension].
 */
object AlertSounds {
    ...
    val all = listOf(
        ...
        Sound("battalion", "BATTALION", "battalion_ticket"),
        ...
        Sound("engine_ladder_battalion", "ENGINE, LADDER, BATTALION", "engine_ladder_battalion_ticket"),
